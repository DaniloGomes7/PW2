...
if(!empty($email) && !empty($nome) && !empty($senha)){
    //pegamos a senha digitado pelo o usuario e realizamops uma 
    //criptografia nela com base nisso, vamos armazenar o hash(criptografia) no banco de dados.
    ...
    echo'<p style="color:red;">Preencha todos os campos por favor!! </p>';
}
